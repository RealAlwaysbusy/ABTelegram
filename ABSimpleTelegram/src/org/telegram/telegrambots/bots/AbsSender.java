...
public abstract class AbsSender {
    ...
    @Hide
    public Message sendMessage(SendMessage sendMessage) throws TelegramApiException, JSONException {
        if (sendMessage == null) {
    ...
    @Hide
    public Boolean answerInlineQuery(AnswerInlineQuery answerInlineQuery) throws TelegramApiException, JSONException {
    ...
    @Hide
    public Boolean sendChatAction(SendChatAction sendChatAction) throws TelegramApiException, JSONException {
    ...
    @Hide
    public Message forwardMessage(ForwardMessage forwardMessage) throws TelegramApiException, JSONException {
    ...
    @Hide
    public Message sendLocation(SendLocation sendLocation) throws TelegramApiException, JSONException {
    ...
    @Hide
    public Message sendVenue(SendVenue sendVenue) throws TelegramApiException, JSONException {
        if (sendVenue == null) {
    ...
    @Hide
    public Message sendContact(SendContact sendContact) throws TelegramApiException, JSONException {
        if (sendContact == null) {
    ...
    @Hide
    public Boolean kickMember(KickChatMember kickChatMember) throws TelegramApiException, JSONException {
    ...
    @Hide
    public Boolean unbanMember(UnbanChatMember unbanChatMember) throws TelegramApiException, JSONException {
    ...
    @Hide
    public Message editMessageText(EditMessageText editMessageText) throws TelegramApiException, JSONException {
    ...
    @Hide
    public Message editMessageCaption(EditMessageCaption editMessageCaption) throws TelegramApiException, JSONException {
    ...
    @Hide
    public Message editMessageReplyMarkup(EditMessageReplyMarkup editMessageReplyMarkup) throws TelegramApiException, JSONException {
    ...
    @Hide
    public Boolean answerCallbackQuery(AnswerCallbackQuery answerCallbackQuery) throws TelegramApiException, JSONException {
    ...
    @Hide
    public UserProfilePhotos getUserProfilePhotos(GetUserProfilePhotos getUserProfilePhotos) throws TelegramApiException, JSONException {
    ...
    @Hide
    public File getFile(GetFile getFile) throws TelegramApiException, JSONException{
    	if(getFile == null){
    ...
    @Hide
    public User getMe() throws TelegramApiException, JSONException {
    ...
    @Hide
    public void editMessageReplyMarkupAsync(EditMessageReplyMarkup editMessageReplyMarkup, SentCallback<Message> sentCallback) throws TelegramApiException {
        if (editMessageReplyMarkup == null) {
            throw new TelegramApiException("Parameter editMessageReplyMarkup can not be null");
        }
        if (sentCallback == null) {
    ...
    @Hide
    public Message sendDocument(SendDocument sendDocument) throws TelegramApiException, JSONException {
        ...
        if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
        	...
        	return null;
            //throw new TelegramApiException("Error at sendDocument", "");
        }
    ...
    @Hide
    public void sendDocumentAsync(SendDocument sendDocument, SentCallback<Message> callback) throws TelegramApiException, JSONException {
    	exe.submit(new Runnable() {
            ...
            public void run() {  
            	 try {
                     ...
                     JSONObject jsonObject = new JSONObject(responseContent);
                     if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
                         callback.onError(sendDocument, jsonObject);
                     }
                     callback.onResult(sendDocument, jsonObject);
             	} catch (IOException | UnsupportedCharsetException | JSONException e) {
                     callback.onException(sendDocument, e);
             	}
            }
    	});
    }
    ...
    @Hide
    public Message sendPhoto(SendPhoto sendPhoto) throws TelegramApiException, JSONException {
        ...
        if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
        	BA.Log(jsonObject.toString(4));
        	return null;
            //throw new TelegramApiException("Error at sendPhoto", "");
        }
    ...
    @Hide
    public void sendPhotoAsync(SendPhoto sendPhoto, SentCallback<Message> callback) throws TelegramApiException, JSONException {
    	exe.submit(new Runnable() {
            @Override
            public void run() {        
            	try {
            		...
            		JSONObject jsonObject = new JSONObject(responseContent);
                    if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
                        callback.onError(sendPhoto, jsonObject);
                    }
                    callback.onResult(sendPhoto, jsonObject);
            	} catch (IOException | UnsupportedCharsetException | JSONException e) {
                    callback.onException(sendPhoto, e);
            	}
    ...
    @Hide
    public Message sendVideo(SendVideo sendVideo) throws TelegramApiException, JSONException {
        String responseContent;
        try {
            CloseableHttpClient httpClient = HttpClients.createDefault();
        ...
        if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
        	BA.Log(jsonObject.toString(4));
        	return null;
            //throw new TelegramApiException("Error at sendVideo", "");
        }
    ...
    @Hide
    public void sendVideoAsync(SendVideo sendVideo, SentCallback<Message> callback) throws TelegramApiException, JSONException {
    	exe.submit(new Runnable() {
            @Override
            public void run() {  
            	try {
                    ...
                    JSONObject jsonObject = new JSONObject(responseContent);
                    if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
                        callback.onError(sendVideo, jsonObject);
                    }
                    callback.onResult(sendVideo, jsonObject);
            	} catch (IOException | UnsupportedCharsetException | JSONException e) {
                    callback.onException(sendVideo, e);
            	}
            }
    	});
    }
    ...
    @Hide
    public Message sendSticker(SendSticker sendSticker) throws TelegramApiException, JSONException {
        String responseContent;
        ...
        if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
        	BA.Log(jsonObject.toString(4));
        	return null;
            //throw new TelegramApiException("Error at sendSticker", "");
        }
    ...
    @Hide
    public void sendStickerAsync(SendSticker sendSticker, SentCallback<Message> callback) throws TelegramApiException, JSONException {
    	exe.submit(new Runnable() {
            @Override
            public void run() {  
            	try {
                    ...
                    JSONObject jsonObject = new JSONObject(responseContent);
                    if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
                        callback.onError(sendSticker, jsonObject);
                    }
                    callback.onResult(sendSticker, jsonObject);
            	} catch (IOException | UnsupportedCharsetException | JSONException e) {
                    callback.onException(sendSticker, e);
            	}
            }
    	});
    }
     ...
     */
    @Hide
    public Message sendAudio(SendAudio sendAudio) throws TelegramApiException, JSONException {
        String responseContent;
        ...
        if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
        	BA.Log(jsonObject.toString(4));
        	return null;
            //throw new TelegramApiException("Error at sendAudio", "");
        }
    ...
    @Hide
    public void sendAudioAsync(SendAudio sendAudio, SentCallback<Message> callback) throws TelegramApiException, JSONException {
    	exe.submit(new Runnable() {
            @Override
            public void run() {  
            	try {
                    ...
                    JSONObject jsonObject = new JSONObject(responseContent);
                    if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
                        callback.onError(sendAudio, jsonObject);
                    }
                    callback.onResult(sendAudio, jsonObject);
            	} catch (IOException | UnsupportedCharsetException | JSONException e) {
                    callback.onException(sendAudio, e);
            	}
     ...
     */
    @Hide
    public Message sendVoice(SendVoice sendVoice) throws TelegramApiException, JSONException {
        String responseContent;
        ...
        if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
        	BA.Log(jsonObject.toString(4));
        	return null;
            //throw new TelegramApiException("Error at sendVoice", "");
        }
    ...
    @Hide
    public void sendVoiceAsync(SendVoice sendVoice, SentCallback<Message> callback) throws TelegramApiException, JSONException {
    	exe.submit(new Runnable() {
            @Override
            public void run() {  
            	try {
                    ...
                    JSONObject jsonObject = new JSONObject(responseContent);
                    if (!jsonObject.getBoolean(Constants.RESPONSEFIELDOK)) {
                        callback.onError(sendVoice, jsonObject);
                    }
                    callback.onResult(sendVoice, jsonObject);
            	} catch (IOException | UnsupportedCharsetException | JSONException e) {
                    callback.onException(sendVoice, e);
            	}
            }
    	});
    }
    ...
    private void sendApiMethodAsync(@SuppressWarnings("rawtypes") BotApiMethod method, @SuppressWarnings("rawtypes") SentCallback callback) {
        exe.submit(new Runnable() {
    ...
    private Serializable sendApiMethod(@SuppressWarnings("rawtypes") BotApiMethod method) throws TelegramApiException, JSONException {
        String responseContent;
        try {
            CloseableHttpClient httpclient = HttpClientBuilder.create().setSSLHostnameVerifier(new NoopHostnameVerifier()).build();
            String url = getBaseUrl() + method.getPath();
