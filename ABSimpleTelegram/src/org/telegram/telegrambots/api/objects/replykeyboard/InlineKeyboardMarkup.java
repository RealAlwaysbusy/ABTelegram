...
public class InlineKeyboardMarkup implements ReplyKeyboard {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3465486958909686852L;
	private static final String KEYBOARD_FIELD = "inline_keyboard";
    @JsonProperty(KEYBOARD_FIELD)
    private List<InlineKeyboardRow> keyboard; ///< Array of button rows, each represented by an Array of Strings
    ...
    public InlineKeyboardMarkup setKeyboard(List<InlineKeyboardRow> keyboard) {
