...
public class InlineKeyboardButton implements IBotApiObject, IToJson {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3694178922617863965L;
    ...
    */
    ...
    public InlineKeyboardButton(JSONObject jsonObject) throws JSONException {
        super();
    ...
    public JSONObject toJson() throws JSONException {
        ...
        jsonObject.put(TEXT_FIELD, emojiText);
        if (url != null) {
