...
public class Update implements IBotApiObject {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5990580584223739026L;
    ...
    private static final String CHOSENINLINERESULT_FIELD = "chosen_inline_result";
    ...
    @JsonProperty(CHOSENINLINERESULT_FIELD)
    private ChosenInlineResult chosenInlineResult; ///< Optional. The result of a inline query that was chosen by a user and sent to their chat partner
    ...
    public Update(JSONObject jsonObject) throws JSONException {
        ...
        */
        if (jsonObject.has(CHOSENINLINERESULT_FIELD)) {
            this.chosenInlineResult = new ChosenInlineResult(jsonObject.getJSONObject(CHOSENINLINERESULT_FIELD));
        }
    ...
    public void serialize(JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        */
        if (chosenInlineResult != null) {
            gen.writeObjectField(CHOSENINLINERESULT_FIELD, chosenInlineResult);
        }
