...
public class InlineQueryResultVoice implements InlineQueryResult {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1556570640720612513L;
    ...
    public void serialize(JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        if (replyMarkup != null) {
            gen.writeObjectField(REPLY_MARKUP_FIELD, replyMarkup.toJson());
        }
        if (inputMessageContent != null) {
            gen.writeObjectField(INPUTMESSAGECONTENT_FIELD, inputMessageContent.toJson());
        }
        gen.writeEndObject();
        gen.flush();
    }
